...
async fn run_metrics_calculation(
    ...
    sensible_attribute: &str, data_points: &mut Vec<LLM_DataPoint>) -> Result<(usize, u32, u32), String> {
                ...
                match response {
                    Ok(val) => {
                        data_points.push(LLM_DataPoint {
                            ...
                            data_point_id: generate_data_point_id(), // TODO:
...
pub async fn calculate_llm_metrics(llm_model_id: u128, dataset: String, max_queries: usize, seed: u32) -> Result<LLM_MetricsAPIResult, String> {
    ...
    match dataset.as_str() {
        "pisa" => {
            ...
            // TODO: add invariant conterfactual metrics objects
            res = run_metrics_calculation(hf_model, seed, max_queries, train_csv, test_csv, cf_test_csv, "male", &mut data_points).await;
