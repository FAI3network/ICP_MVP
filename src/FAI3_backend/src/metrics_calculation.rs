...
// Internal functions
pub(crate) fn statistical_parity_difference(data_points: &Vec<DataPoint>, privilieged_threshold: Option<HashMap<String, f64>>) -> (Vec<PrivilegedIndex>, f32) {
    let (
        privileged_count,
        unprivileged_count,
...
pub(crate) fn disparate_impact(data_points: &Vec<DataPoint>, privilieged_threshold: Option<HashMap<String, f64>>) -> (Vec<PrivilegedIndex>, f32) {
    let (
        privileged_count,
        unprivileged_count,
        privileged_positive_count,
...
pub(crate) fn average_odds_difference(data_points: &Vec<DataPoint>, privilieged_threshold: Option<HashMap<String, f64>>) -> (Vec<PrivilegedIndex>, f32) { 
    let (
        privileged_tp,
        privileged_fp,
        privileged_tn,
...
pub(crate) fn equal_opportunity_difference(data_points: &Vec<DataPoint>, privilieged_threshold: Option<HashMap<String, f64>>) -> (Vec<PrivilegedIndex>, f32) {
...
pub(crate) fn all_metrics(data_points: &Vec<DataPoint>, privilieged_threshold: Option<HashMap<String, f64>>) -> ((Vec<PrivilegedIndex>, f32), (Vec<PrivilegedIndex>, f32), (Vec<PrivilegedIndex>, f32), (Vec<PrivilegedIndex>, f32), f32, f32, f32) {
...
mod metrics_calculation_tests {
    ...
    mod test_accuracy {
        ...
        // TODO: decide what to do or how to tests ic_cdk traps
        // #[test]
