...
export default function LLMDetails({ model, metrics, fetchModel }: any) {
  ...
  const generalChartConfig = {
    general_lms: {
      label: "General Lms",
      color: "#2563eb",
      description: "general_lms",
      key: "general_lms",
    },
    general_n: {
      label: "General N",
      color: "#60a5fa",
      description: "general_n",
      key: "general_n",
    },
    general_ss: {
      label: "General SS",
      color: "#10b981",
      description: "general_ss",
      key: "general_ss",
    },
  };
            ...
            {isOwner && (
              <>
                <div className="w-full flex justify-between">
                  ...
                  <Button onClick={() => setOpenTestModal(true)}>Run test</Button>

                  <LLMTestsModal isOpen={openTestModal} onClose={() => setOpenTestModal(false)} fetchModel={fetchModel} />
                  ...
                  <AddModelModal
                    ...
                    is_llm
                    hf_url={model.model_type.LLM.hugging_face_url}
                  />

                  <Button onClick={() => setOpenEditModal(true)}>Edit Model</Button>
                </div>
              </>
            )}
          </div>
            ...
            <Card className="bg-[#fffaeb]">
              ...
              <CardContent className="grid grid-cols-1 gap-8 max-h-96">
                <div className="grid gap-4 h-fit text-lg">
                  ...
                  <p>
                    <strong>Hugging Face URL:</strong> {model.model_type?.LLM?.hugging_face_url}
                  </p>
                </div>
              </CardContent>
            </Card>
